...
using WebApplicationFCCCrashCourseJokeApp.Data;
using WebApplicationFCCCrashCourseJokeApp.Models;

namespace WebApplicationFCCCrashCourseJokeApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            /* to see in the console what are the SQL Requests going on there :) */
            var rqs = _context.Joke.Where(j => j.JokeQuestion.Contains(SearchPhrase)).ToString();
            Console.WriteLine(rqs);
